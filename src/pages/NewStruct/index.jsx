...
const _MODEL_PATH_ = [
  require("../../models/examples/ball.obj"),
  require("../../models/examples/cone.obj"),
...
class ParticleSystem {
  ...
  createScene() {
    ...
    this.scene.fog = new THREE.FogExp2(328972, 0.0005);
    // 创建相机
  ...
  _addModels() {
    ...
    for (const i of _MODEL_PATH_) {
      ...
      loader.load(i, (group) => {
        ...
        finalGeometry.scale(100, 100, 100)
...
const NewStruct = () => {
  ...
  useEffect(() => {
    const onLoad = () => {
      console.log(2);
      new ParticleSystem(world.current);
      console.log(1);
    };
    onLoad();
  }, []);

  return <div className="bg" id="world" ref={world}></div>;
};
